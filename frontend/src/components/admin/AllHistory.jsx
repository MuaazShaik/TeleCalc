...
export default function AllHistory() {
  ...
  return (
    <div>
      <h3 className="section-title">📜 All Call History</h3>
      {history.length === 0 ? <div className="empty-state">No calculations yet</div> : (
        <div className="table-wrap">
          <table className="data-table">
            <thead><tr><th>Date</th><th>Agent</th><th>Plan</th><th>Start</th><th>Duration</th><th>Peak</th><th>Off-Peak</th><th>Free Used</th><th>Charge</th><th>Holiday</th></tr></thead>
            <tbody>
              {history.map(h => (
                <tr key={h.id}>
